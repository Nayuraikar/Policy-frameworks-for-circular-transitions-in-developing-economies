...
cr_list <- semTools::compRelSEM(cfa_fit)
cr_num <- sapply(cr_list, as.numeric)
ave_num <- semTools::AVE(cfa_fit)
rel_table <- rbind(CR = cr_num, AVE = ave_num)
print(round(rel_table, 3))
